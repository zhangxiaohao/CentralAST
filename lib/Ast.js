...
var AddressRangeTable = require("./AddressRangeTable");

function Ast(siteNumber) {
	this.doc = [];
...
修改对应客户端的副本范围
*/
Ast.prototype.SetARTTableByClient = function(l, r, clientNumber) {
	this.ART.AddRecord(l, r, this.timeStamp, clientNumber);
}
